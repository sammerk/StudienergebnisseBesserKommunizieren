...
\title{Evidenz. Besser. Kommunizieren.}
...
wird das Potenzial zugeschrieben, diese Entscheidungsprozesse ergänzend
...
geschickte Wissenschaftskommunikation voraussetzt. Der vorliegende
...
\& Rolff, 1978}) finden sich u.a. Ansätze mit Entlehnungen aus der
...
die Genese und Interpretation von Evidenz nicht zu den ausgeprägtesten
professionellen Kompetenzen von Lehrkräften gehört
(\citeproc{ref-gussen2023}{Gussen et al., 2023}) und andererseits
Bildungswissenschaftler- und Fachdidaktiker:innen wohl oft keine
Expert:innen für die praktische Gestaltung von Schule und Unterricht
sein dürften, plädiert der vorliegende Beitrag dafür,
Wissenschaftskommunikation erstens als wichtige Aufgabe von
Bildungswissenschaftler:innen und Fachdidaktiker:innen aufzufassen,
zweitens das Gelingen von Wissenschaftskommunikation zum Gegenstand
empirischer Forschung zu machen und drittens die Entwicklung von neuen
Wissenschaftskommunikationsformaten als dialogischen Prozess zwischen
Bildungswissenschaften, Fachdidaktiken und (angehenden) Lehrkräften
aufzufassen.

Zur Begründung dieser Plädoyers führt der vorliegende Beitrag zunächst
in Konzepte und Begriffe evidenzinformierter Praxis sowie in
Wissenschaftskommunikation in der Lehrpersonenbildung ein. Anschließend
wird die vorliegende Studie -- ein kleines Experiment zur Kommunikation
der Entwicklung der Lesekompetenz in den deutschen Kohorten des
Programme of International Student Assessment (PISA) -- als empirisches
Beispiel angeführt.
...
sprechen. Vielmehr ist in Definitionsvorschlägen von »wissenschaftlichem
Wissen« (\citeproc{ref-stark2017}{Stark, 2017}), von einer »Funktion«
von Daten für die Bestätigung oder Widerlegung von Hypothesen und
Theorien (\citeproc{ref-bromme2014e}{Bromme et al., 2014}) oder von
»warrants for making assertions or knowledge claims«
(\citeproc{ref-shavelson2002}{Shavelson \& Towne, 2002, S. 18}) die
Rede. In einer aktuellen Systematisierung verschiedener Verständnisse
des Evidenz-Begriffs in den Bildungswissenschaften hebt Schmidt
...
nicht-empirischer Entitäten wie Theorien oder logische Analysen mögen
...
1927}; \citeproc{ref-thorndike1904}{Thorndike, 1904}), dass also
unterschiedliche Begriffe für das Gleiche und gleiche Begriffe für
...
wissenschaftskritischen (\citeproc{ref-schmid2007}{Schmid \& Lutz,
...
(ontologischer und epistemologischer Aspekt,
\citeproc{ref-stark2017}{Stark, 2017}) und zum anderen der Evidenz in
der praktischen Verwendung eher eine heuristische Funktion
...
Kommunikation von Evidenz (im Sinne der Induktionen einer konsistenten
Auffassung) eine notwendige Voraussetzung für das Gelingen
...
der Lehrkraft.}{\label{fig-AbbildungMoMa}}}}
...
schlussfolgert sie, dass es Sinn macht, Geld und Zeit in die Anschaffung
und Implementation des KI-Lesetutors zu investieren, weil sie den
KI-Lesetutor für deutlich lernwirksamer hält als lautes Lesen, obwohl
evtl. die Implementation weiterer Maßnahmen effektiver, kostengünstiger
und weniger zeitaufwändig gewesen wäre.
...
\citeproc{ref-schneider2025}{Schneider et al., 2025}). Grundsätzlich
...
bei der Scientific, Data und Statistical Literacy der (angehenden)
Lehrkräfte ansetzen (\citeproc{ref-bruhwiler2020}{Brühwiler \&
Leutwyler, 2020}).
...
Schulleiter:innen mit Forschenden kooperieren. Hierzu gehören auch
»Brokering-Ansätze« (teilweise als »research practice partnerships«
...
(z.B. \citeproc{ref-sharples2015}{Sharples \& Sheard, 2015}). Zudem
können kurz- (\citeproc{ref-merk2020}{Merk et al., 2020}) oder
längerfristig (\citeproc{ref-karst2024}{Karst et al., 2024}) angelegte
Interventionen zur Anbahnung notwendiger Kompetenzen für
evidenzinformiertes Handeln wie die Interpretation von grafisch
dargestellten Daten (\citeproc{ref-friel2001}{Friel et al., 2001}) oder
Forschungskompetenz (\citeproc{ref-neuenschwander2005}{Neuenschwander,
2005}) sowie die konkrete Unterstützung für evidenzinformiertes Handeln
(\citeproc{ref-zotero-8935}{Clearing House Unterricht Academy, 2025}),
diesem Ansatz zugerechnet werden.
...
Lehrkräfte (z.B. \citeproc{ref-rycroft-smith2022}{Rycroft-Smith \&
Stylianides, 2022}; \citeproc{ref-schneider2025}{Schneider et al.,
2025}), was auch das Anliegen der vorliegenden Studie ist.

\begin{table}

{\caption{{Beispiele für angebotsseitige Versuche verbesserter
Kommunikation von Evidenz.}{\label{tbl-wisskommbsp}}}
\vspace{-20pt}}
...
Die vorliegende Studie untersucht, inwiefern verbreitete
Standardgrafiken zur Kommunikation der Entwicklung der Lesekompetenz in
den deutschen Kohorten des Programme of International Student Assessment
(PISA) »Practical Significance Bias«, also das automatische Annehmen
starker Effekte, wenn keine Effektstärken Berichtet werden, induzieren
und ob dieser mit Grafiken verringert werden kann, bei deren Gestaltung
...
als Trendstudie (\citeproc{ref-duxf6ring2016}{Döring \& Bortz, 2016})
konsequent erscheint.

\begin{table}

{\caption{{Verwendete Liniendiagramme in der
Berichterstattung.}{\label{tbl-pisalinegraphs}}}
\vspace{-20pt}}
...
sowohl über die Zeit als auch über Variablen (hier: Fächer) hinweg. In
...
Mittelwerte von 508 (PISA Lesen 2015) und 480 (PISA Lesen 2022) bei
unterschiedlichen Streuungen.
...
{\caption{{Verwendete Stimuli}{\label{tbl-materials}}}
\vspace{-20pt}}
...
Sehbeeinträchtigungen geachtet (\citeproc{ref-garnier2023}{Garnier et
al., 2024}). Um unnötige Arbeitsgedächtnisbelastung zu vermeiden, wurde
die Legende direkt in die Grafik integriert
...
Gruppen deutlich über dem wahren Wert (Liniendiagramm .80,
...
Die vorgestellte Studie stellt lediglich ein kleines Experiment an einer
selektiven Gelegenheitsstichprobe ohne Präregistrierung dar. Interne und
ökologische Validität konnten aufgrund des experimentellen Designs mit
realweltlichen Materialien dennoch gestärkt werden. Die externe und
Konstruktvalidität litt jedoch sicher an der großen Homogenität und
Spezifität der Stichprobe, sehr spezifisch gewähltem Kontext (PISA
Lesekompetenz) sowie theoretisch etwas arbiträren unabhängigen Variablen
(viele weitere Gestaltungsprinzipien wären denkbar). Zudem wäre die
Untersuchung weiterer abhängiger Variablen wie Cognitive Load oder
wahrgenommene Informativität wünschenswert.
...
ermöglicht, Evidenz »besser« an Lehramtsstudierende und Lehrkräfte zu
kommunizieren. Dabei wurde »besser« als »weniger gebiased«
operationalisiert und gezeigt, dass die Wahl einer theoretisch
fundierten grafischen Darstellung einen deutlich geringeren Bias
induzierte als eine Standardgrafik. Allerdings war auch die Rezeption
der verbesserten Darstellung immer noch erheblich verzerrt (siehe
Abbildung~\ref{fig-plotresults}).
...
\& Jolley, 2010}) als auch bildungswissenschaftliche Literatur (z.B.
\citeproc{ref-bohl2015a}{Bohl et al., 2015};
\citeproc{ref-dewe1992}{Dewe et al., 1992}) haben die Möglichkeiten und
Limitationen der Abgrenzbarkeit von »Wissenschaft« und
»Nicht-Wissenschaft« (bzw. in den Bildungswissenschaften von »Theorie«
und »Praxis«) diskutiert und heben u.a. hervor, dass Entitäten und
Aussagen in ihrer Bedeutung primär an den Herkunftskontext (z.B.
»Wissenschaft« oder »Praxis«) gebunden sind. Also ist auch z.B. die
»Evidenz« einer explanativen bildungswissenschaftlichen Studie per se
zunächst bildungswissenschaftlich und muss für eine evidenzinformierte
Handlung in der Praxis reinterpretiert werden (z.B.
...
(etwa der American Educational Research Association) äußerst selten und
selbst in Fachzeitschriften nicht unbedingt erwartbar sind
(\citeproc{ref-mcmillan2011}{McMillan \& Jennifer, 2011}). Für eine
...
(\citeproc{ref-schneider2025}{2025}) etwa, dass selbst eine als leicht
...
Berufsgruppen (\citeproc{ref-mcdowell2017}{McDowell \& Jacobs, 2017}),
...
Nutzendenmerkmalen (\citeproc{ref-bruhwiler2020}{Brühwiler \& Leutwyler,
...
American Psychological Association. (2019). \emph{Publication manual of
...
Schultheorie} (1. Aufl). utb.
\url{https://doi.org/10.36198/9783838541808}

\bibitem[\citeproctext]{ref-bohrer2025}
Bohrer, K., Schmidt, K., \& Merk, S. (2025). {Zwei Studien, ein
Ergebnis: Lehramtsstudierende unterliegen im Umgang mit Evidenz dem
Ankereffekt}. \emph{Zeitschrift für Erziehungswissenschaft},
\emph{28}(4), 951--980. \url{https://doi.org/10.1007/s11618-025-01309-z}
...
Clearing House Unterricht Academy. (2025). \emph{Clearing House
Unterricht Academy}. \url{https://clearinghouse-academy.de/}
...
Dewe, B., Ferchhoff, W., \& Radtke, F.-O. (1992). \emph{Das
{,,}Professionswissen{``} von Pädagogen} (B. Dewe, W. Ferchhoff, \& F.
Olaf-Radtke, Hrsg.; S. 70--91). Springer VS.
\url{https://doi.org/10.1007/978-3-663-09988-8_5}

\bibitem[\citeproctext]{ref-duxf6ring2016}
Döring, N., \& Bortz, J. (2016). \emph{Forschungsmethoden und Evaluation
in den Sozial- und Humanwissenschaften} (5. Aufl.). Springer.
...
\emph{32}(2), 124--158. \url{https://doi.org/10.2307/749671}

\bibitem[\citeproctext]{ref-frischkorn2023}
Frischkorn, G. T., \& Popov, V. (2023). \emph{A tutorial for estimating
{Bayesian} hierarchical mixture models for visual working memory tasks:
{Introducing} the {Bayesian} measurement modeling (bmm) package for
{R}}. \url{https://doi.org/10.31234/osf.io/umt57}
...
{R}}. \url{https://doi.org/10.32614/CRAN.package.viridis}

\bibitem[\citeproctext]{ref-gigerenzer2005}
Gigerenzer, G., Hertwig, R., Van Den Broek, E., Fasolo, B., \&
Katsikopoulos, K. V. (2005). {„A {30\%} Chance of Rain Tomorrow``}: How
does the public understand probabilistic weather forecasts? \emph{Risk
Analysis}, \emph{25}(3), 623--629.
...
\bibitem[\citeproctext]{ref-gussen2023}
Gussen, L., Schumacher, F., Großmann, N., Ferreira González, L.,
Schlüter, K., \& Großschedl, J. (2023). Supporting Pre-Service Teachers
in Developing Research Competence. \emph{Frontiers in Education},
\emph{8}. \url{https://doi.org/10.3389/feduc.2023.1197938}
...
(2024). \emph{Die Etablierung von Evidenzteams in SchuMaS - Eine
Strategie zur systematischen Nutzung von Daten für die Schul- und
...
Leitz, A., Kleen, H., Hartmann, U., \& Kunter, M. (2024). Was K{ö}nnen
Wir Aus Der {Grundschullehrkraft-Perspektive} Auf
{Transferaktivit{ä}ten} Lernen? {Die Vorstellung} Eines Kokonstruktiven
{Clearinghouse-Ansatzes}. \emph{Tagung Der {Gesellschaft} F{ü}r
...
McMillan, J. H., \& Jennifer, F. (2011). Reporting and Discussing Effect
Size: {Still} the Road Less Traveled. \emph{Practical Assessment,
Research, and Evaluation}, \emph{16}(1).
...
OECD (Hrsg.). (2023). \emph{{PISA} 2022 {Ergebnisse} ({Band} {I}):
{Lernstände} und {Bildungsgerechtigkeit}}. wbv Media.
...
RBB. (2023). \emph{Deutsche Schülerinnen und Schüler schneiden bei neuer
...
\bibitem[\citeproctext]{ref-rycroft-smith2022}
Rycroft-Smith, L., \& Stylianides, A. J. (2022). What makes a good
educational research summary? {A} comparative judgement study of
mathematics teachers' and mathematics education researchers' views.
\emph{Review of Education}, \emph{10}(1), e3338.
\url{https://doi.org/10.1002/rev3.3338}

\bibitem[\citeproctext]{ref-Schildkamp2018}
Schildkamp, K., Handelzalts, A., Poortman, C. L., Leusink, H., Meerdink,
M., Smit, M., Ebbeler, J., \& Hubers, M. D. (2018). \emph{The data team™
procedure: {A} systematic approach to school improvement}. Springer.
...
Schmidt, K. (2024). \emph{Teachers' engagement with educational science.
{How} to communicate findings from educational science in a
user-friendly way to teachers} {[}Phdthesis, Pädagogische Hochschule
Karlsruhe{]}.
...
Schneider, J., Schmidt, K., Bohrer, K., \& Merk, S. (2025).
Communicating {Effect} {Sizes} to {Teachers}: {Exploring} {Different}
{Visualizations} and {Their} {Enrichment} {Options}. \emph{Zeitschrift
für Psychologie}, \emph{233}(1), 52--63.
\url{https://doi.org/10.1027/2151-2604/a000573}
...
taz. (2023). \emph{Pisa-Schock für deutsche Schü­le­r:in­nen: Im freien
Fall \textbar{} taz.de}.
